...
- **Cells** opens named kilometres. The catalog tank is still the 2 × 2 km lab (no atlas fetch). Other tiles try GMRT at a known site and fall back to a synthetic floor.
