...
The default cell is the **catalog tank** — the same 10 km lab as the map button: beach, stepped shelves, canyon, seamount, 2000 m of water, every implemented animal. `--place shelf` is the synthetic North Sea fallback.
